...
Для построения дерева и подсчета количества различных подстрок файлы настроек одинаковы, но в файле для проверки наличия подстроки есть дополнительная строка
~~~
